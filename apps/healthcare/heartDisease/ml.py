...
def ml():
	...
	with st.expander("Prediction Results"):
		...
		m = joblib.load("apps/healthcare/heartDisease/rf_model")
		...
		if prediction == 1:
			st.warning("Positive Heart Disease Risk!!! Exercise Everyday please...")
			prob_score = {"Probability of Positive Risk": prob[0][1],
			"Probability of Negative Risk": prob[0][0]}
			st.write(prob_score)

		else:
			st.success("Negative Heart Disease Risk!!! No need to worry...")
			prob_score = {"Probability of Negative Risk": prob[0][0],
			"Probability of Positive Risk": prob[0][1]}
			st.write(prob_score)